...
function assertPlainClosedInput(input) {
  ...
  const normalizedInputText = descriptors.text.value.normalize("NFKC");
  if (
    /[A-Za-z][A-Za-z0-9+.-]*:[^\s]/u.test(normalizedInputText)
    || /[A-Za-z][A-Za-z0-9+.-]*:[\t\n\r]/u.test(normalizedInputText)
    || /[\\/]/u.test(normalizedInputText)
    || /\bwww[.\u3002\uFF0E\uFF61]/iu.test(normalizedInputText)
    || /(?:^|\s)\S*[?#]\S+/u.test(normalizedInputText)
  ) {
