...
function bindTrustedFetchJson(fetchImpl) {
...
export function createPrimarySourceVerifierWithTrustedTransport({ fetchImpl }) {
  const fetchJsonExact = bindTrustedFetchJson(fetchImpl);
  return Object.freeze({
    verify(input) {
