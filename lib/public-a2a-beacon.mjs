...
const DISCOVERY_GROUPS = Object.freeze({
  ...
  inclusion: Object.freeze({
    ...
    links: Object.freeze([
      Object.freeze({ rel: "registry", href: `${PUBLIC_SITE}registry.json` }),
      Object.freeze({ rel: "registry-schema", href: `${PUBLIC_SITE}registry.schema.json` }),
      Object.freeze({ rel: "feed-index", href: `${PUBLIC_SITE}feeds/index.json` })
    ])
  }),
  ens: Object.freeze({
...
function validateConfiguration(configuration) {
  ...
  if (configuration.taskPushNotificationConfig !== undefined) {
    throw protocolError("PUSH_NOTIFICATION_NOT_SUPPORTED", "push notifications are not supported by the discovery beacon");
  }
...
function validateSendMessageRequest(request) {
  ...
  if (message.taskId !== undefined) {
    ...
    throw protocolError("TASK_NOT_FOUND", "the stateless discovery beacon retains no tasks");
  }
  if (message.referenceTaskIds !== undefined) {
    ...
    if (message.referenceTaskIds.length > 0) throw protocolError("TASK_NOT_FOUND", "the stateless discovery beacon retains no referenced tasks");
  }
  ...
  if (part.mediaType !== undefined && part.mediaType !== "text/plain") {
    throw protocolError("CONTENT_TYPE_NOT_SUPPORTED", "the discovery beacon accepts only text/plain input parts");
  }
  ...
  return Object.freeze({
    ...
    sendMessage(request) {
      ...
      const part = useJson
        ...
        : Object.freeze({ text: responseText(group), mediaType: "text/plain" });
      return Object.freeze({
