...
} from "./observed-public-a2a-beacon.mjs";
...
function writeUnsupportedOperation(response) {
  writeA2AError(response, 400, "FAILED_PRECONDITION", "This operation is not supported by the read-only Reception beacon", "UNSUPPORTED_OPERATION");
}
  ...
  return async function handlePublicA2ARequest(request, response) {
    ...
    if (url.pathname === "/health") {
      ...
      writeJson(response, 200, {
        status: "ready",
        service: "vortik-public-a2a-reception-beacon",
