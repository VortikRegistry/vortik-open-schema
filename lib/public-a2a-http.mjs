  ...
  return async function handlePublicA2ARequest(request, response) {
    ...
    if (taskCancelMatch) {
      ...
      if (request.method !== "POST") {
        writeProblem(response, 405, "method_not_allowed", "Task cancel uses the wrong method");
        return;
      }
    ...
    if (taskGetMatch) {
      ...
      if (request.method !== "GET") {
        writeProblem(response, 405, "method_not_allowed", "Task get uses the wrong method");
        return;
      }
      writeProblem(response, 404, "task_not_found", "The stateless discovery beacon retains no tasks");
      return;
