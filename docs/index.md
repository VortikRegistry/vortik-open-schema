...
- [`agent-discovery.md`](agent-discovery.md) — documents the machine-readable public discovery manifest, currently advertised capabilities, and the explicit pre-A2A trust boundary.
