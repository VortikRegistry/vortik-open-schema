...
- [`agent-discovery.md`](agent-discovery.md) — documents the machine-readable public discovery manifest, currently advertised capabilities, and the live bounded A2A lifecycle and trust boundary.
