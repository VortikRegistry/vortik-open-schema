...
- minimal → avoid narrative abstraction
- composable → designed to interoperate across surfaces
- versioned → reflect semantic evolution over time
- non-authoritative → track convergence, not enforce definitions
...
- a registry of stabilized terminology
- a reference layer for tooling and indexing
- a bridge between research discussion and machine-readable structure

Its purpose is to:

- reduce ambiguity
- track terminology convergence
- enable consistent interpretation across research, infrastructure, and protocol discussions
